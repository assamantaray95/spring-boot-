package com.bmy.webapp.controllers;

import com.bmy.webapp.models.Client;
import com.bmy.webapp.models.ClientDto;
import com.bmy.webapp.repositories.ClientRepository;
...
public class ClientController {
    ...
    public String editClient(Model model, @RequestParam int id) {
        Client client = clientRepo.findById((long) id).orElse(null);
        if(client == null) {
            return "redirect:/clients";
        }
    ...
    public String deleteClient(@RequestParam int id) {
        clientRepo.findById((long) id).ifPresent(client -> clientRepo.delete(client));
        return "redirect:/clients";
    }
}
